...
class MeasurementResult:
    ...
    def _calculate_hash(self) -> str:
        ...
        try:
            ...
            hash_data['combined_uncertainty'] = budget_summary['combined_uncertainty'].get(
    ...
    def format_result(self, format_type: str = "standard") -> str:
        ...
        try:
            ...
            if format_type == "standard":
                ...
                return (
                    f"{self.value:.3f} ± {uncertainty:.3f} {self.unit} "
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        return {
            ...
            'metadata': {
                ...
                'procedure_id': self.metadata.procedure_id,
                'instrument_id': self.metadata.instrument_id,
                'calibration_date': self.metadata.calibration_date.isoformat()
                if self.metadata.calibration_date
                else None,
...
def create_simple_measurement(
    ...
    # Create metadata
    metadata = MeasurementMetadata(operator_id=operator_id, procedure_id=procedure_id, instrument_id=instrument_id)

    return MeasurementResult(
        measurement_id=measurement_id, value=value, unit=unit, uncertainty_budget=budget, metadata=metadata
    )
