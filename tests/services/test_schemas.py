...
def test_answer_valid(S_ANSWER: Schema) -> None:
    ok: JSONObj = {
        ...
        "citations": [
            {"type": "statute", "label": "KC art. 647¹", "ref": "Dz.U....", "locator": "art. 647(1) §2"}
        ],
        "metrics": {"confidence": 0.92, "latency_ms": 120},
        "model": {"provider": "LEXENITH", "name": "GPT-5 Thinking", "version": "2025.08"},
...
def test_pca2_valid(S_PCA2: Schema) -> None:
    ok: JSONObj = {
        ...
        "attestations": [
            {"subject": "answer#aaaaaaaa", "by": "auditor.bot", "result": "pass", "at": "2025-08-14T10:05:00Z"}
        ],
        "audit_trail": [
            {"type": "constraint_eval", "at": "2025-08-14T10:05:01Z", "actor": "cerber", "message": "OK"}
        ],
        "overall_status": "pass",
        "final_hash": "2" * 64
    }
