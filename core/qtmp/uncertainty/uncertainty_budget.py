...
class UncertaintyBudget:
    ...
    def add_type_a_component(
        self, component_id: str, observations: list[float], description: str = "", sensitivity_coefficient: float = 1.0
    ...
    def calculate_combined_uncertainty(self) -> dict[str, Any]:
        ...
        for (id1, id2), corr in self.correlation_matrix.items():
            ...
            correlation_term = (
                2 * corr * comp1.sensitivity_coefficient * comp1.value * comp2.sensitivity_coefficient * comp2.value
            )
