...
class ProofArtifactManager:
    ...
    async def load_artifact(self, artifact_id: str) -> ProofArtifact | None:
        ...
        try:
            ...
            if isinstance(data.get("proof_data"), str) and data["proof_data"].endswith("_proof.txt"):
    ...
    async def list_artifacts(self, solver_type: SolverType | None = None, since: datetime | None = None) -> list[str]:
...
__all__ = ['SolverType', 'ProofResult', 'SolverConfig', 'ProofArtifact', 'SMTSolverInterface', 'ProofArtifactManager']
