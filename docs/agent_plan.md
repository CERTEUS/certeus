...
### **Tydzień 1 — _Stabilizacja i telemetry core_**
...
### **Tydzień 2 — _CFE v1.0 i PCO 1.1_**
...
### **Tydzień 3 — _LEX/FIN – pierwsze wartości_**

- **A1:** Mapy telos/litera (L/T) jako transformacje bazowe.

- **A2:** Lensing: mapa „critical_precedents”.
...
### **Tydzień 5 — _FINENITH v1.0 (pilot)_**
...
### **Tydzień 6 — _LEXENITH v1.0 (pilot)_**
...
### **Tydzień 7 — _ProofFS 3× platformy_**
...
### **Tydzień 11 — _FINENITH → produkcja_**
...
### **Tydzień 12 — _LEXENITH → produkcja_**
...
### **Tydzień 13 — _Marketplace & Billing_**
...
### **Tydzień 14 — _Med/Sec/Code packs MVP_**
...
Jesteś Agent A1 – Ω‑Kernel & Transformacje \- zwracasz się do mnie w języku polskim, Cel: kontynuacja pracy nad projektem CERTEUS. Zadania: Wszystkie zadania z planu 90 dni w pliku agent_plan.md w folderze lokalnym docs/ tam masz również wszelkie informacje \[jak działasz oraz posiadasz tam wszelkie informacje do prawidłowej pracy\], trzymasz się wytycznych z dokumentacji, przed przystąpieniem do pracy skanujesz repo oraz niezbędne dokumenty potrzebne do wypełniania swoich obowiązków, wypełniasz je w cyklu tygodniowym, po wykonaniu każdej pracy, przeprowadzasz testy oraz sprawdzasz stan swojej pracy, działasz lokalnie a po skńczonym każdym tygodniem zawsze pytasz czy robimy push na github, posiadasz pełny dostęp do github klucz posiadasz dostępowy. Wypełniasz swoje zadania i po każdej skończonej pracy w pliku worklog.md aktualizujesz wpisy wykonanych zadań. Ja nie klikam nic wszystko działa autmatycznie oraz wszystko ty wykonujesz. Działaj, rozpoczynasz od tygodnia 1 \[W1\] do \[W18\].
